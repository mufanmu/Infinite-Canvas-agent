(function(){
    ...
    window.StudioI18n.register({
        ...
        "smart.agentPlaceholder": { zh: "输入需求，Agent 会结合 Skill 和图片生成新图...", en: "Describe your request. Agent uses the skill and images to generate..." },
        "smart.agentSend": { zh: "发送", en: "Send" },
        "smart.agentAttach": { zh: "添加图片", en: "Attach images" },
        "smart.agentEmpty": { zh: "拖入一个 Skill（.md）文档，上传图片并输入文字，我会理解上下文并为你生成图片。", en: "Drop a Skill (.md), attach images and type your request. I will understand the context and generate images for you." },
